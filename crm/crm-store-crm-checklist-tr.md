...
Bu doküman, Aydınlı Grup franchise mağazalarında (U.S. Polo Assn., Pierre Cardin, Cacharel) CRM operasyonlarının eksiksiz ve doğru yürütülmesi için kullanılacak kontrol listelerini içerir.
...
|------|-------|---------|---------|
| 1 | CRM sistemine giriş yap | Tüm personel | ☐ |
| 2 | Günlük hedefleri kontrol et | Mağaza Müdürü | ☐ |
| 3 | Açık ticketları kontrol et | Mağaza Müdürü | ☐ |
| 4 | Aktif kampanyaları gözden geçir | Tüm personel | ☐ |
| 5 | Sistem uyarılarını kontrol et | Mağaza Müdürü | ☐ |

### Gün İçi

| Sıra | Görev | Sorumlu | Kontrol |
|------|-------|---------|---------|
| 1 | Her satışta müşteri eşleştirmesi yap | Satış personeli | ☐ |
| 2 | Yeni müşteri kayıtlarını doğru gir | Satış personeli | ☐ |
| 3 | KVKK izinlerini al ve kaydet | Satış personeli | ☐ |
| 4 | Kupon/puan işlemlerini doğru uygula | Satış personeli | ☐ |
| 5 | Müşteri şikayetlerini ticket olarak kaydet | Satış personeli | ☐ |
| 6 | Loyalty penetration oranını izle | Mağaza Müdürü | ☐ |

### Mağaza Kapanışı

| Sıra | Görev | Sorumlu | Kontrol |
|------|-------|---------|---------|
| 1 | Günlük CRM performansını değerlendir | Mağaza Müdürü | ☐ |
| 2 | Loyalty penetration hedefini kontrol et | Mağaza Müdürü | ☐ |
| 3 | Açık ticketları gözden geçir | Mağaza Müdürü | ☐ |
| 4 | Ertesi gün için hedef belirle | Mağaza Müdürü | ☐ |
| 5 | CRM sisteminden güvenli çıkış yap | Tüm personel | ☐ |
...
| Sıra | Görev | Sorumlu | Kontrol |
|------|-------|---------|---------|
| 1 | Geçen ay performans raporunu incele | Mağaza Müdürü | ☐ |
| 2 | Aylık CRM hedeflerini belirle | Mağaza Müdürü | ☐ |
| 3 | Personel CRM eğitim ihtiyacını değerlendir | Mağaza Müdürü | ☐ |
| 4 | Ay içi kampanya takvimini gözden geçir | Mağaza Müdürü | ☐ |

### Ay Ortası

| Sıra | Görev | Sorumlu | Kontrol |
|------|-------|---------|---------|
| 1 | Aylık hedef gerçekleşme durumunu değerlendir | Mağaza Müdürü | ☐ |
| 2 | Düşük performans alanları için aksiyon al | Mağaza Müdürü | ☐ |
| 3 | Veri kalitesi denetimi yap | Mağaza Müdürü | ☐ |
| 4 | KVKK uyumluluk kontrolü yap | Mağaza Müdürü | ☐ |

### Ay Sonu

| Sıra | Görev | Sorumlu | Kontrol |
|------|-------|---------|---------|
| 1 | Aylık CRM performans raporunu hazırla | Mağaza Müdürü | ☐ |
| 2 | Loyalty program performansını değerlendir | Mağaza Müdürü | ☐ |
| 3 | Ticket çözüm oranlarını analiz et | Mağaza Müdürü | ☐ |
| 4 | Segment dağılımını incele | Mağaza Müdürü | ☐ |
| 5 | İyileştirme önerilerini belirle | Mağaza Müdürü | ☐ |
| 6 | Bölge müdürüne aylık rapor gönder | Mağaza Müdürü | ☐ |
...
## Müşteri Kaydı Kontrol Listesi

### Veri Girişi Kontrolleri

| Alan | Kontrol | Doğru Format |
|------|---------|--------------|
| Ad | İlk harf büyük mü? | Ahmet |
| Soyad | İlk harf büyük mü? | Yılmaz |
| Telefon | 10 hane ve 5 ile başlıyor mu? | 5321234567 |
| E-posta | @ ve domain var mı? | ahmet@email.com |
| Doğum Tarihi | GG/AA/YYYY formatında mı? | 15/03/1985 |
| Cinsiyet | Seçildi mi? | Erkek/Kadın |

### KVKK Kontrolleri

| Görev | Kontrol |
|-------|---------|
| Aydınlatma metni gösterildi/okundu mu? | ☐ |
| Veri işleme izni alındı mı? (Zorunlu) | ☐ |
| SMS izni soruldu ve kaydedildi mi? | ☐ |
| E-posta izni soruldu ve kaydedildi mi? | ☐ |
| Arama izni soruldu ve kaydedildi mi? | ☐ |
| İzin formu imzalatıldı/dijital onay alındı mı? | ☐ |

### Kayıt Sonrası Kontroller

| Görev | Kontrol |
|-------|---------|
| Customer ID oluşturuldu mu? | ☐ |
| Müşteriye kayıt bilgisi verildi mi? | ☐ |
| Welcome bonus tanımlandı mı? (varsa) | ☐ |
| Sistem kayıt onayı görüntülendi mi? | ☐ |
...
### Günlük Kontrol Sorumlusu

| Kontrol | Birincil | Yedek |
|---------|----------|-------|
| Açılış kontrolleri | Vardiya Sorumlusu | Mağaza Müdürü |
| Gün içi kontroller | Her personel (kendi işlemi) | Vardiya Sorumlusu |
| Kapanış kontrolleri | Mağaza Müdürü | Vardiya Sorumlusu |

### Haftalık Kontrol Sorumlusu

| Kontrol | Sorumlu |
|---------|---------|
| Tüm haftalık kontroller | Mağaza Müdürü |
| Haftalık rapor | Mağaza Müdürü |

### Aylık Kontrol Sorumlusu

| Kontrol | Sorumlu |
|---------|---------|
| Tüm aylık kontroller | Mağaza Müdürü |
| Aylık rapor | Mağaza Müdürü |
| Uyumluluk denetimi | Bölge Müdürü |
