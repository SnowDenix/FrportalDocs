---
layout: default
title: "Rehberler & Eğitim (TR)"
parent: Consolidated Documentation
nav_order: 10
---

# Rehberler & Eğitim - Tam Dokümantasyon (Türkçe)

> **Konsolide Doküman**  
> **Son Güncelleme:** 8 Aralık 2025  
> **Hazırlayan:** Aydınlı Grup
>
> **Kaynak Dosyalar:** guidelines, training klasörlerinden 9 dosya
...
3. [İletişim Kanalları](#iletişim-kanalları)
4. [Raporlama Standartları](#raporlama-standartları)
5. [Sipariş ve Tedarik İletişimi](#sipariş-ve-tedarik-iletişimi)
6. [Escalation Prosedürleri](#escalation-prosedürleri)
7. [Toplantı ve Görüşme Protokolleri](#toplantı-ve-görüşme-protokolleri)
8. [Kriz İletişimi](#kriz-iletişimi)
...
└──────────────┬──────────────────────┘
    ...
    │          │          │
┌───▼───┐  ┌───▼───┐  ┌───▼───┐
│Satış  │  │Operasyon│ │Finans │
│Direktör│  │Direktör │ │Direktör│
└───┬───┘  └───┬───┘  └───┬───┘
    │          │          │
┌───▼───┐  ┌───▼───┐  ┌───▼───┐
│Bölge  │  │Lojistik│  │Muhasebe│
...
|------|---------------------|-----------------|
| Günlük Satış | Mağaza Müdürü | Bölge Müdürü |
| Sipariş | Operasyon Müdürü | Sipariş Takip |
| Sevkiyat | Operasyon Müdürü | Lojistik Müdürü |
| Finansal | Finans Müdürü | Muhasebe Müdürü |
| VM/Marketing | Satış Müdürü | Marketing |
...
Mağaza: [Mağaza Adı]
                 ...
                 Bugün    Hedef    Gerçekleşme
Satış:           _____    _____    ___%
İşlem:           _____    _____    ___%
UPT:             _____    _____    ___%
ATV:             _____    _____    ___%
Ziyaretçi:       _____    _____    ___%
...
- Mevcut stok değeri
- Stok cover (hafta)
- Kritik stok uyarıları (cover < 4 hafta)
- Transfer talepleri

**Performans Raporu (Her Pazartesi 12:00'ye kadar)**
...
|--------|-------|------|---------|
| **L1** | Rutin konular | 24 saat | İlgili uzman |
| **L2** | Çözülemeyen L1 | 48 saat | Departman Müdürü |
...
| Konu | L1 | L2 | L3 | L4 |
|------|-----|-----|-----|-----|
| Sipariş gecikmesi | Sipariş Uzmanı | Sipariş Müdürü | Operasyon Dir. | GM |
| Sevkiyat sorunu | Lojistik Uzmanı | Lojistik Müdürü | Operasyon Dir. | GM |
| Kalite sorunu | QC Uzmanı | QC Müdürü | Operasyon Dir. | GM |
...
ESCALATION BİLDİRİMİ

Tarih/Saat: [GG/AA/YYYY HH:MM]
Escalation Seviyesi: L[X]
Önceki Seviye Ref: [Varsa ticket no]

SORUN TANIMI:
[Detaylı açıklama]

ETKİ ANALİZİ:
- Mali Etki: [Tahmini tutar]
- Operasyonel Etki: [Açıklama]
- Müşteri Etkisi: [Açıklama]

YAPILAN AKSIYONLAR:
1. [Tarih] - [Aksiyon]
2. [Tarih] - [Aksiyon]

TALEP EDİLEN AKSİYON:
[Net talep]

BEKLENEN ÇÖZÜM SÜRESİ: [X saat/gün]
...
| Tür | Tanım | Öncelik |
|-----|-------|---------|
| **Operasyonel Kriz** | Tedarik kesintisi, mağaza kapanışı | Yüksek |
| **Finansal Kriz** | Ödeme sorunları, döviz krizi | Yüksek |
...
1. Krizi Tespit Et ve Değerlendir
   ↓
2. Kriz Ekibini Aktive Et
   ↓
3. İlk 1 Saat: Durum Raporu Hazırla
   ↓
4. İlk 2 Saat: İç Paydaşları Bilgilendir
   ↓
5. İlk 4 Saat: Aksiyon Planı Oluştur
   ↓
6. Sürekli: Durum Güncellemeleri (her 4 saat)
   ↓
...
5. [Aydınlı Müşteri Deneyimi Modeli](#aydınlı-müşteri-deneyimi-modeli)
6. [Karşılama Standartları](#karşılama-standartları)
7. [Kabin Hizmeti](#kabin-hizmeti)
8. [Problem Çözme ve Şikayet Yönetimi](#problem-çözme-ve-şikayet-yönetimi)
9. [CRM Aksiyonları](#crm-aksiyonları)
10. [Rol Sorumlulukları](#rol-sorumlulukları)
11. [KPI ve Performans Göstergeleri](#kpi-ve-performans-göstergeleri)
12. [Senaryolar](#senaryolar)
13. [Sık Yapılan Hatalar ve Koçluk Notları](#sık-yapılan-hatalar-ve-koçluk-notları)
14. [Değerlendirme Yöntemleri](#değerlendirme-yöntemleri)
...
| Rol | Eğitim İçeriği |
|-----|----------------|
| **Satış Danışmanı** | Tüm müşteri deneyimi standartları |
| **Kasiyer** | Ödeme deneyimi, veda |
...
```
┌─────────────────────────────────────────────────────────────────────────────┐
│                    MÜŞTERİ YOLCULUĞU HARİTASI                               │
├─────────────────────────────────────────────────────────────────────────────┤
│                                                                             │
│   1.KEŞIF        2.GİRİŞ        3.GEZİNME       4.DENEME       5.SATIN ALMA│
│      │             │               │               │               │        │
│      ▼             ▼               ▼               ▼               ▼        │
│  ┌───────┐    ┌─────────┐    ┌─────────┐    ┌─────────┐    ┌─────────┐    │
│  │Vitrin │    │Karşılama│    │ Yardım  │    │  Kabin  │    │  Kasa   │    │
│  │Online │    │İlk İzlenim│   │ Sunum  │    │ Hizmeti │    │ Ödeme   │    │
│  │Reklam │    │         │    │ Öneri   │    │         │    │ Paket   │    │
│  └───────┘    └─────────┘    └─────────┘    └─────────┘    └─────────┘    │
│                                                                             │
│   6.VEDA         7.SONRASI                                                 │
...
| Terim | Tanım | Önemi |
|-------|-------|-------|
| **CX (Customer Experience)** | Müşteri deneyimi | Tüm temas noktalarının toplamı |
| **NPS (Net Promoter Score)** | Tavsiye skoru | Müşteri sadakati ölçümü |
| **CSAT (Customer Satisfaction)** | Müşteri memnuniyeti | Anlık memnuniyet ölçümü |
| **Touchpoint** | Temas noktası | Müşteriyle etkileşim anı |
...
│                                                                 │
│  💡 Hedef: Beklenen'i karşıla, Şaşırtıcı anlar yarat           │
│                                                                 │
└─────────────────────────────────────────────────────────────────┘
```
...
```
┌─────────────────────────────────────────────────────────────────┐
│              İLK 10 SANİYE STANDARDI                            │
├─────────────────────────────────────────────────────────────────┤
│                                                                 │
│  SANİYE 1-3: GÖZ TEMASI                                        │
│  • Müşteriyi fark et                                           │
│  • Göz teması kur                                              │
│  • Gülümse                                                     │
│                                                                 │
│  SANİYE 4-7: KARŞILAMA                                         │
│  • "Hoş geldiniz" de                                           │
│  • Samimi ton kullan                                           │
│  • Açık beden dili sergile                                     │
│                                                                 │
│  SANİYE 8-10: DAVET                                            │
│  • "Buyurun, bekleriz" de                                      │
│  • Alan yarat (takip etme)                                     │
│  • Mevcut ol (çok uzaklaşma)                                   │
│                                                                 │
└─────────────────────────────────────────────────────────────────┘
```
...
✅ "Günaydın/İyi günler, hoş geldiniz!"
✅ "Hoş geldiniz, yardımcı olabilir miyim?"
```

**Duruma Özel Karşılama:**
```
Yağmurlu gün: "Hoş geldiniz, ıslanmadınız umarım!"
Soğuk gün: "Hoş geldiniz, içerisi sıcak, buyurun!"
Yoğun gün: "Hoş geldiniz, biraz yoğunuz ama hemen ilgileneceğim."
...
| Doğru | Yanlış |
|-------|--------|
| Ayakta, dik duruş | Oturma, yaslanma |
| Göz teması | Telefonla ilgilenme |
| Açık kollar | Kavuşturulmuş kollar |
| Samimi gülümseme | Suni/zorlama ifade |
| 1.5-2m mesafe | Çok yakın/çok uzak |
...
│      • "Anlıyorum, çok can sıkıcı olmuş"                       │
│      • "Haklısınız, bu kabul edilemez"                         │
│                                                                 │
...
|---------|-----------|-------|
| **Hatalı ürün** | "Çok özür dilerim, hemen değiştirelim" | Anında değişim/iade |
| **Yanlış beden** | "Hemen doğru bedeni bulalım" | Beden değişimi |
| **Fiyat farkı** | "Kontrol edeyim hemen" | Fiyat düzeltme/indirim |
...
```
┌─────────────────────────────────────────────────────────────────┐
│              ŞİKAYET YÖNETİMİ DİYALOĞU                         │
├─────────────────────────────────────────────────────────────────┤
│                                                                 │
│ MÜŞTERİ: "Bu gömleği geçen hafta aldım, ilk yıkamada          │
│           rengi aktı. Bu kabul edilemez!"                       │
│                                                                 │
│ PERSONEL: [DİNLE - Sözünü kesme]                               │
│                                                                 │
│ PERSONEL: "Çok iyi anlıyorum, gerçekten çok can sıkıcı        │
│            bir durum. Yeni aldığınız bir üründe böyle          │
│            bir şey yaşamak çok hayal kırıklığı yaratır."       │
│            [EMPATİ KUR]                                         │
│                                                                 │
│ PERSONEL: "Bu durumdan dolayı çok özür dilerim. Bu bizim      │
│            için de kabul edilebilir değil."                    │
│            [ÖZÜR DİLE]                                         │
│                                                                 │
│ PERSONEL: "Hemen çözelim. Size iki seçenek sunabilirim:       │
│            Yeni bir ürünle değişim yapabiliriz veya            │
│            tam iade yapabiliriz. Hangisini tercih edersiniz?"  │
│            [ÇÖZ]                                               │
│                                                                 │
│ MÜŞTERİ: "Değişim olsun."                                      │
│                                                                 │
│ PERSONEL: "Hemen hallediyorum. Bu arada, yaşadığınız          │
│            durumu not alıyorum ve merkeze bildireceğim.        │
...
├── Basit şikayetler
├── Beden/renk değişimi
├── Küçük fiyat farklılıkları
└── Bekleme şikayetleri

        │ Çözemezse
        ▼

SEVİYE 2: MAĞAZA MÜDÜRÜ
├── Karmaşık iade talepleri
├── Yüksek tutarlı şikayetler
...
SEVİYE 3: BÖLGE MÜDÜRÜ / HQ
├── Yasal konular
├── Medya tehdidi
├── Ciddi ürün kusurları
└── Sistemik sorunlar
```
...
| Sorumluluk | Detay |
|------------|-------|
| Karşılama | Her müşteriye standart karşılama |
| Kabin hizmeti | Profesyonel deneme hizmeti |
| Problem çözme | İlk seviye şikayet çözümü |
...
| Sorumluluk | Detay |
|------------|-------|
| Standart denetimi | Günlük CX standart kontrolü |
| Şikayet yönetimi | 2. seviye şikayet çözümü |
| CRM yönetimi | Veri kalitesi takibi |
...
| Sorumluluk | Detay |
|------------|-------|
| Mystery shopping | Gizli müşteri koordinasyonu |
| Best practice | Başarılı örnekleri paylaşma |
| Eskalasyon | 3. seviye şikayet çözümü |
...
ADIMLAR:
1. Müşteriyi tanı: CRM'den doğum günü bilgisi kontrol et
2. Özel karşılama: "Hoş geldiniz [İsim] Hanım, doğum gününüz 
   yaklaşıyor, ne güzel!"
3. Sürpriz teklif: "Doğum gününüze özel %15 indirim kodunuz var"
4. Ekstra ilgi: "Size özel yeni sezon parçalarını göstereyim mi?"
5. Hediye: Küçük bir doğum günü hediyesi (aksesuar, parfüm örneği)
...
2. Müşteriyi sessiz alana davet et: "Buyurun şuraya geçelim, 
   rahat konuşalım"
3. LEARN modelini uygula:
   - DİNLE: Şikayeti tam olarak dinle
   - EMPATİ: "Çok iyi anlıyorum, sinir bozucu bir durum"
   - ÖZÜR: "Bu durumdan dolayı çok özür dilerim"
   - ÇÖZ: "Hemen yeni ürün verelim veya iade yapalım"
   - BİLDİR: "Kalite ekibine bildireceğim"
4. Telafi öner: "Yaşadığınız için bir sonraki alışverişinizde 
   %10 indirim kullanın"
...
DURUM: Müşteri uzun süredir mağazada dolaşıyor, 
       yardım istemiyor ama kaybolmuş görünüyor.

ADIMLAR:
1. Gözlem: 3-4 dakika izle
2. Doğal yaklaşım: Yanından geçerken göz teması kur
3. Yumuşak teklif: "Bir şey arayıp bulamadıysanız 
   yardımcı olabilirim"
4. İhtiyaç analizi: "Ne tür bir ürün düşünüyorsunuz?"
5. Yönlendirme: İlgili bölüme götür, ürün öner

SONUÇ: Kayıp satış kurtarılır, müşteri memnun ayrılır
```
...
```
┌─────────────────────────────────────────────────────────────────┐
│              GİZLİ MÜŞTERİ DEĞERLENDİRME FORMU                 │
├─────────────────────────────────────────────────────────────────┤
│ Mağaza: _________________  Tarih: ___/___/______               │
│ Ziyaret Saati: _____  Değerlendiren: _________________         │
├─────────────────────────────────────────────────────────────────┤
│                                           Evet  Hayır  N/A     │
│ KARŞILAMA                                                       │
│ 10 saniye içinde göz teması             [ ]   [ ]    [ ]       │
│ Sıcak karşılama yapıldı                 [ ]   [ ]    [ ]       │
│ Gülümseme vardı                         [ ]   [ ]    [ ]       │
│                                                                 │
│ HİZMET KALİTESİ                                                │
│ İhtiyaç analizi yapıldı                 [ ]   [ ]    [ ]       │
│ Ürün bilgisi yeterliydi                 [ ]   [ ]    [ ]       │
│ Kabin hizmeti profesyoneldi             [ ]   [ ]    [ ]       │
│ Ek satış önerisi yapıldı                [ ]   [ ]    [ ]       │
│                                                                 │
│ KASA DENEYİMİ                                                  │
│ Hızlı işlem yapıldı                     [ ]   [ ]    [ ]       │
│ CRM kaydı teklif edildi                 [ ]   [ ]    [ ]       │
│ Teşekkür edildi                         [ ]   [ ]    [ ]       │
│                                                                 │
│ VEDA                                                            │
│ Sıcak uğurlama yapıldı                  [ ]   [ ]    [ ]       │
│ Tekrar davet edildi                     [ ]   [ ]    [ ]       │
│                                                                 │
...
├─────────────────────────────────────────────────────────────────┤
│                                                                 │
│ "Bu mağazayı bir arkadaşınıza veya aile üyenize               │
