...
- **Mağaza Müdürleri:** Kampanya uygulaması, yerel pazarlama koordinasyonu
- **Bölge Müdürleri:** Bölgesel pazarlama stratejisi ve bütçe yönetimi
- **Franchise Sahipleri:** Pazarlama yatırım kararları ve ROI takibi
- **Merkez Pazarlama Ekibi:** Merkezi kampanya geliştirme ve marka yönetimi

### Kapsanan Faaliyetler

1. Marka pazarlaması ve konumlandırma
2. Sezonluk ve promosyonel kampanyalar
3. Dijital ve sosyal medya pazarlaması
4. Mağaza içi pazarlama ve POSM
5. Yerel pazar aktivasyonu
6. Pazarlama performans ölçümü
...
|-------|----------|--------|
| POSM Uygulaması | Pazarlama malzemelerini doğru şekilde sergilemek | Kampanya başına |
| Müşteri İletişimi | Müşterileri mevcut promosyonlar hakkında bilgilendirmek | Günlük |
| Kampanya Geri Bildirimi | Müşteri tepkilerini ve sorularını raporlamak | Haftalık |
| Sosyal Medya Desteği | Yerel sosyal medya içeriğini desteklemek | Talep üzerine |
| Veri Toplama | CRM için müşteri bilgilerini yakalamak | Her işlem |

### Mağaza Müdürü

| Görev | Açıklama | Sıklık |
|-------|----------|--------|
| Kampanya Uygulaması | Tüm kampanya unsurlarının uygulandığından emin olmak | Kampanya başına |
| Personel Eğitimi | Ekibi kampanya mesajları konusunda eğitmek | Kampanya başına |
| Yerel Koordinasyon | Yerel medya ve ortaklarla koordinasyon | Gerektiğinde |
| Performans Takibi | Kampanya satış etkisini izlemek | Günlük/Haftalık |
| Geri Bildirim Raporlaması | Kampanya performans raporları sunmak | Haftalık |
| Bütçe Yönetimi | Yerel pazarlama giderlerini yönetmek | Aylık |

### Bölge Müdürü

| Görev | Açıklama | Sıklık |
|-------|----------|--------|
| Strateji Uygulaması | Bölgesel pazarlama stratejisini yürütmek | Sürekli |
| Bütçe Dağılımı | Pazarlama bütçesini mağazalar arasında dağıtmak | Üç ayda bir |
| Performans Analizi | Bölgesel pazarlama performansını analiz etmek | Haftalık |
| Yerel Adaptasyon | Kampanyaları bölgesel gereksinimlere göre uyarlamak | Kampanya başına |
| Ajans Yönetimi | Bölgesel pazarlama ajanslarıyla koordinasyon | Sürekli |
| Uyumluluk Denetimi | Marka kılavuzu uyumluluğunu sağlamak | Aylık |

### Merkez Pazarlama Ekibi

| Görev | Açıklama | Sıklık |
|-------|----------|--------|
| Kampanya Geliştirme | Merkezi pazarlama kampanyaları oluşturmak | Sezonluk |
| Marka Yönetimi | Marka kılavuzlarını sürdürmek ve geliştirmek | Sürekli |
| Varlık Üretimi | Pazarlama malzemeleri ve varlıkları üretmek | Kampanya başına |
| Performans Analizi | Küresel pazarlama performansını analiz etmek | Aylık |
| Bütçe Planlaması | Yıllık pazarlama bütçesi geliştirmek | Yıllık |
| Ortak Desteği | Franchise sahiplerine pazarlama desteği sağlamak | Sürekli |
...
## Marka Pazarlama Sütunları

### U.S. Polo Assn.

**Marka Konumlandırması:** Polo mirası ile otantik Amerikan yaşam tarzı markası

| Sütun | Açıklama | Anahtar Mesajlar |
|-------|----------|------------------|
| **Miras** | Polo sporu ile otantik bağlantı | "USPA'nın Resmi Markası" |
| **Yaşam Tarzı** | Amerikan gündelik yaşam tarzı | "Otantik Yaşa" |
| **Kalite** | Erişilebilir fiyatlarla güvenilir kalite | "Güvenebileceğiniz Kalite" |
| **Çok Yönlülük** | Spordan sokağa | "Kendi Tarzında Oyna" |

**Pazarlama Tonu:**
- Özgüvenli ve otantik
- Sportif ama sofistike
- Kapsayıcı ve erişilebilir
- Enerjik ve iyimser

**Görsel Kimlik:**
- Ana Renkler: Lacivert, Beyaz, Kırmızı
- İkincil Renkler: Yeşil, Sarı
- Görseller: Aktif yaşam tarzı, polo referansları, Amerikan manzaraları
...
**Marka Konumlandırması:** Romantik, feminen Fransız bohem tarzı

| Sütun | Açıklama | Anahtar Mesajlar |
|-------|----------|------------------|
| **Romantizm** | Romantik Fransız estetiği | "Sade Romantizm" |
| **Kadınsılık** | Kadınları kutlamak | "Modern Kadınsılık" |
| **Doğa** | Çiçekli ve doğal ilhamlar | "Doğal Güzellik" |
| **Neşe** | Eğlenceli ve iyimser | "Neşeli Yaşam" |
...
**Görsel Kimlik:**
- Ana Renkler: Pastel tonlar, Beyaz, Pembe
- İkincil Renkler: Çiçek desenleri, Yumuşak maviler
- Görseller: Bahçeler, çiçekler, romantik ortamlar, sanatsal ifadeler
...
### Seviye 1: Ana Sezonluk Kampanyalar

| Özellik | Detaylar |
|---------|----------|
| **Sıklık** | Yılda 2 (SS, FW) |
| **Süre** | 8-12 hafta |
| **Bütçe Tahsisi** | Yıllık pazarlama bütçesinin %40'ı |
| **Kanallar** | ATL + BTL + Dijital + Mağaza İçi |
| **Merkez Desteği** | Tam kampanya kiti, medya planlaması |

### Seviye 2: Promosyonel Kampanyalar

| Özellik | Detaylar |
|---------|----------|
| **Sıklık** | Yılda 4-6 |
| **Süre** | 1-4 hafta |
| **Bütçe Tahsisi** | Yıllık pazarlama bütçesinin %30'u |
| **Kanallar** | BTL + Dijital + Mağaza İçi |
| **Merkez Desteği** | Kampanya kılavuzları, POSM şablonları |

### Seviye 3: Yerel Aktivasyonlar

| Özellik | Detaylar |
|---------|----------|
| **Sıklık** | Gerektiğinde |
| **Süre** | Etkinliğe özgü |
| **Bütçe Tahsisi** | Yıllık pazarlama bütçesinin %20'si |
| **Kanallar** | Yerel medya + Mağaza İçi |
| **Merkez Desteği** | Marka kılavuzları, onay süreci |

### Sürekli Aktif Faaliyetler

| Özellik | Detaylar |
|---------|----------|
| **Sıklık** | Sürekli |
| **Süre** | Yıl boyunca |
| **Bütçe Tahsisi** | Yıllık pazarlama bütçesinin %10'u |
| **Kanallar** | Sosyal medya, CRM, SEO |
| **Merkez Desteği** | İçerik takvimi, şablonlar |
...
| Kategori | Toplam % | Açıklama |
|----------|----------|----------|
| **Medya Satın Alma** | %40 | Kanallar arası ücretli reklamcılık |
| **Üretim** | %25 | İçerik oluşturma, POSM üretimi |
| **Etkinlikler** | %15 | Aktivasyonlar, sponsorluklar |
| **Ajans Ücretleri** | %10 | Kreatif, medya, PR ajansları |
| **Beklenmedik Durumlar** | %10 | Beklenmeyen fırsatlar |

### Ortak Pazarlama Modeli

```
┌─────────────────────────────────────────────────────────────┐
│              ORTAK PAZARLAMA YAPISI                          │
├─────────────────────────────────────────────────────────────┤
│                                                              │
│  Merkezi Kampanyalar (Merkez Fonlu)                          │
│  ├── Global marka varlıkları                                 │
│  ├── Kampanya kreatif geliştirme                             │
│  └── Temel POSM kiti                                         │
│                                                              │
│  Bölgesel Adaptasyon (50/50 Paylaşım)                        │
│  ├── Yerel dil adaptasyonu                                   │
│  ├── Bölgesel medya satın alma                               │
│  └── Ek POSM miktarları                                      │
│                                                              │
│  Yerel Aktivasyonlar (Franchise Fonlu)                       │
│  ├── Mağazaya özgü promosyonlar                              │
│  ├── Yerel etkinlikler                                       │
│  └── Yerel ortaklıklar                                       │
│                                                              │
└─────────────────────────────────────────────────────────────┘
...
1. Pazarlama Portalı üzerinden bütçe talebi gönderin (30 gün önce)
2. Bölge Müdürü incelemesi (5 iş günü içinde)
3. 5.000 $'ın üzerindeki talepler için Merkez onayı (10 iş günü içinde)
4. PO çıkarılması ve tedarikçi koordinasyonu
5. Faaliyet sonrası mutabakat ve raporlama
...
```
Adım 1: Merkez'den Kampanya Brifingi Al
        ↓
Adım 2: Kampanya Hedeflerini ve KPI'ları İncele
        ↓
Adım 3: Yerel Pazar Gereksinimlerini Değerlendir
        ↓
Adım 4: Lokalizasyon Taleplerini Gönder (gerekirse)
        ↓
Adım 5: Pazarlama Varlıklarını ve POSM'u Al
        ↓
Adım 6: Mağaza Ekiplerini Kampanya Hakkında Bilgilendir
        ↓
Adım 7: Mağaza İçi Kurulumu Uygula
        ↓
Adım 8: Kampanyayı Başlat
        ↓
Adım 9: Performansı Günlük İzle
        ↓
Adım 10: Haftalık Performans Raporları Gönder
        ↓
Adım 11: Kampanya Kapanışı ve Final Raporlama
```

### Pazarlama Onay Süreci

```
Yerel İnisiyatif Önerisi
        ↓
Mağaza Müdürü İncelemesi → Ret → Revize
        ↓ Onay
Bölge Müdürü İncelemesi → Ret → Revize
        ↓ Onay
Merkez Pazarlama İncelemesi (> 5.000 $ ise) → Ret → Revize
        ↓ Onay
Bütçe Tahsisi
        ↓
Uygulama
        ↓
Faaliyet Sonrası Rapor
```
...
### Pazarlama Performans KPI'ları

| KPI | Formül | Hedef | Sıklık |
|-----|--------|-------|--------|
| **ROMI** | (Gelir - Pazarlama Maliyeti) / Pazarlama Maliyeti | 3:1 | Kampanya Başına |
| **Kazanım Başına Maliyet** | Toplam Pazarlama Maliyeti / Yeni Müşteriler | < 25 $ | Aylık |
| **Marka Bilinirliği** | Yardımlı Hatırlama % | > %60 | Üç Ayda Bir |
| **Sosyal Etkileşim Oranı** | (Beğeni + Yorum + Paylaşım) / Takipçi × 100 | > %3 | Haftalık |
| **E-posta Açılma Oranı** | Açılma / Teslim × 100 | > %25 | Kampanya Başına |
| **TO** | Tıklama / Gösterim × 100 | > %2 | Kampanya Başına |
| **Dönüşüm Oranı** | Dönüşüm / Ziyaretçi × 100 | > %3 | Haftalık |
| **Müşteri Kazanım Maliyeti** | Pazarlama Harcaması / Yeni Müşteriler | < 30 $ | Aylık |

### Kampanya ROI Hesaplaması

```
Kampanya ROI = ((Kampanya Geliri - Kampanya Maliyeti) / Kampanya Maliyeti) × 100

Örnek:
- Kampanya Geliri: 150.000 $
- Kampanya Maliyeti: 40.000 $
...
**Belirti:** Müşteriler devam eden kampanyadan haberdar değil.

**Olası Nedenler:**
- Yetersiz POSM görünürlüğü
- Personel düzgün bilgilendirilmedi
- Pazarlama erişimi çok sınırlı

**Çözüm:**
1. POSM yerleşimi ve görünürlüğünü denetleyin
2. Mağaza personelini kampanya detayları hakkında yeniden bilgilendirin
3. Sosyal medya tanıtımını artırın
4. Vitrin displayi önemini artırın
...
### Sorun 4: Bütçe Aşımları

**Belirti:** Gerçek pazarlama harcaması bütçeyi aşıyor.

**Olası Nedenler:**
- Zayıf planlama
- Planlanmamış faaliyetler
- Kapsam kayması

**Çözüm:**
1. Tüm taahhütleri bütçeye karşı aylık inceleyin
2. Planlanmamış faaliyetler için ön onay isteyin
3. Planlamaya beklenmedik durum payı ekleyin
4. Kampanyalar sırasında harcamayı haftalık takip edin
...
- [Marka Kılavuzları](brand-guideline-tr.md)
- [Sezonluk Pazarlama Takvimi](seasonal-marketing-calendar-tr.md)
- [Kampanya Uygulama Rehberi](campaign-execution-guide-tr.md)
- [Dijital Varlık Kullanımı](digital-assets-usage-tr.md)
- [POSM Kılavuzu](posm-guideline-tr.md)
- [Pazarlama Onay Süreci](marketing-approval-process-tr.md)
