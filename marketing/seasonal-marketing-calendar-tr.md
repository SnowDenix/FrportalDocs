...
Bu belge, tüm Aydınlı Grup franchise operasyonları için yıllık pazarlama takvimi çerçevesini sağlar. Marka tutarlılığını korurken ticari fırsatları maksimize ederek tüm markalar ve bölgeler genelinde koordineli pazarlama faaliyetlerini güvence altına alır.

### Takvim Hedefleri

| Hedef | Açıklama |
|-------|----------|
| **Uyum** | Tüm pazarlarda pazarlama faaliyetlerini senkronize etmek |
| **Planlama** | Tüm kampanyalar için önceden hazırlık yapılmasını sağlamak |
| **Optimizasyon** | Yıl boyunca ticari fırsatları maksimize etmek |
| **Tutarlılık** | Küresel olarak birleşik marka mesajlaşması sağlamak |
| **Verimlilik** | Son dakika hazırlıklarını ve maliyetleri azaltmak |
...
| Terim | Tanım |
|-------|-------|
| **Sezon** | Ana perakende dönemi (SS = İlkbahar/Yaz, FW = Sonbahar/Kış) |
| **Kampanya** | Belirli hedeflerle koordineli pazarlama girişimi |
| **Ticari An** | Önemli satış fırsatı (tatil, etkinlik, indirim dönemi) |
| **Lansman Penceresi** | Yeni koleksiyonun satışa sunulduğu dönem |
| **İndirim Dönemi** | Sezonluk tasfiye için indirimli fiyatlandırma dönemi |
| **Karartma Dönemi** | Promosyonların yasak olduğu süre |
| **Zirve Haftası** | Bir dönem içindeki en yüksek trafik/satış haftası |
| **Hazırlık Süresi** | Kampanya uygulamasından önce gereken süre |
...
## Yıllık Takvim Genel Bakış

### 12 Aylık Pazarlama Takvimi

```
┌─────────────────────────────────────────────────────────────────────────────┐
│                        YILLIK PAZARLAMA TAKVİMİ                              │
├─────────────────────────────────────────────────────────────────────────────┤
│                                                                              │
│  Q1 (Oca-Mar)                    │  Q2 (Nis-Haz)                            │
│  ├── Kış İndirimi (Oca)          │  ├── Ramazan/Bayram (Bölgesel)           │
│  ├── Sevgililer Günü (Şub)       │  ├── Anneler Günü (May)                  │
│  └── SS Sezon Lansmanı (Mar)     │  └── Yaz Zirvesi (Haz)                   │
│                                  │                                          │
│  Q3 (Tem-Eyl)                    │  Q4 (Eki-Ara)                            │
│  ├── Yaz İndirimi (Tem)          │  ├── Kara Cuma (Kas)                     │
│  ├── Okula Dönüş (Ağu)           │  ├── Bekarlar Günü (11 Kas)              │
│  └── FW Sezon Lansmanı (Eyl)     │  └── Tatil Sezonu (Ara)                  │
│                                                                              │
└─────────────────────────────────────────────────────────────────────────────┘
```
...
| Ay | Birincil Odak | İkincil Etkinlikler | Pazarlama Önceliği |
|----|---------------|---------------------|-------------------|
| **Ocak** | Kış İndirimi | Yeni Yıl | Yüksek |
| **Şubat** | Sevgililer Günü | SS Ön İzleme | Orta |
| **Mart** | SS Sezon Lansmanı | Kadınlar Günü | Çok Yüksek |
| **Nisan** | Ramazan (Bölgesel) | Bahar Tatili | Yüksek |
| **Mayıs** | Anneler Günü | Bayram (Bölgesel) | Yüksek |
| **Haziran** | Yaz Koleksiyonu | Babalar Günü | Orta |
| **Temmuz** | Yaz İndirimi | Tatil | Yüksek |
| **Ağustos** | Okula Dönüş | Yaz Sonu | Çok Yüksek |
| **Eylül** | FW Sezon Lansmanı | Moda Haftası | Çok Yüksek |
| **Ekim** | Sezon Ortası | Halloween (Seçili) | Orta |
| **Kasım** | Kara Cuma | Bekarlar Günü | Çok Yüksek |
| **Aralık** | Tatil Sezonu | Yıl Sonu İndirimi | Çok Yüksek |
...
Hafta 1-8: Tam Fiyat Satış Dönemi
        ↓
Hafta 9-12: Kara Cuma / Tatil Hazırlığı
        ↓
Hafta 13+: Tatil Zirvesi ve Yıl Sonu İndirimi
```
...
| Dönem | Kampanya | Süre | Temel Faaliyetler |
|-------|----------|------|-------------------|
| **Ağu H4 - Eyl H1** | FW Ön İzleme | 2 hafta | VIP erişim, trend ön izleme |
| **Eyl H2** | FW Lansmanı | 1 hafta | Tam mağaza yenilemesi, moda etkinliği |
| **Eyl H2 - Kas H2** | Sonbahar Odağı | 9 hafta | Katmanlama, geçiş görünümleri |
| **Kas H3** | Kara Cuma | 1 hafta | Büyük indirimler, kapı açılış ürünleri |
| **Ara H1-3** | Tatil Sezonu | 3 hafta | Hediye rehberi, şenlikli koleksiyonlar |
| **Ara H4** | Yıl Sonu İndirimi | 1 hafta | Final tasfiye |

### Markaya Göre FW Hero Ürünler

| Marka | FW Hero Kategorileri | Pazarlama Odağı |
|-------|---------------------|-----------------|
| **U.S. Polo Assn.** | Kazaklar, Dış giyim, Botlar | Kampüs tarzı, hafta sonu casual |
| **Pierre Cardin** | Takımlar, Paltolar, Triko | İş zarafeti, akşam giyimi |
| **Cacharel** | Elbiseler, Mantolar, Aksesuarlar | Romantik katmanlar, parti sezonu |

### FW Görsel Temalar

| Ay | Vitrin Teması | Renk Hikayesi |
|----|---------------|---------------|
| Eylül | Temellere Dönüş | Lacivert, Bordo, Deve tüyü |
| Ekim | Sonbahar Katmanları | Toprak tonları, Zengin renkler |
| Kasım | Kentsel Şıklık | Siyah, Gri, Cesur vurgular |
| Aralık | Şenlikli Büyü | Altın, Kırmızı, Tatil parıltısı |
...
| Değerlendirme | Detaylar | Etki |
|---------------|----------|------|
| **İslami Takvim** | Ramazan, Ramazan Bayramı, Kurban Bayramı | Önemli ticari anlar |
| **Hafta Sonu** | Cuma-Cumartesi | Farklı trafik kalıpları |
| **Alışveriş Saatleri** | Ramazan'da uzatılmış | Mağaza operasyonları |
| **Muhafazakar Moda** | Muhafazakar tercihler | Ürün seçimi |
| **Yaz Sıcağı** | Haz-Ağu aşırı sıcaklıklar | Kapalı AVM odağı |

**KSA'ya Özgü Takvim Eklemeleri:**

| Etkinlik | Zamanlama | Pazarlama Odağı |
|----------|-----------|-----------------|
| Ramazan | Değişken (Kameri) | Akşam alışverişi, aile hediyeleri |
| Ramazan Bayramı | Ramazan sonu | Kutlama kıyafetleri, hediyeler |
| Kurban Bayramı | Ramazan Bayramı'ndan 70 gün sonra | Premium ürünler, aile |
| Ulusal Gün | 23 Eylül | Vatansever temalar |
| Kuruluş Günü | 22 Şubat | Miras kutlaması |

### Fas

| Değerlendirme | Detaylar | Etki |
|---------------|----------|------|
| **İslami Takvim** | KSA ile aynı | Önemli ticari anlar |
| **Fransız Etkisi** | Avrupa moda takvimi | Çift etki |
| **Turizm Sezonu** | Yaz zirvesi | Uluslararası müşteriler |
| **Yerel Tatiller** | Bağımsızlık Günü, Tahta Günü | Bölgesel promosyonlar |

**Fas'a Özgü Takvim Eklemeleri:**

| Etkinlik | Zamanlama | Pazarlama Odağı |
|----------|-----------|-----------------|
| Ramazan/Bayram | Değişken | Aile kutlamaları |
| Bağımsızlık Günü | 18 Kasım | Ulusal gurur |
| Tahta Günü | 30 Temmuz | Kutlama |
| Yeşil Yürüyüş | 6 Kasım | Vatansever temalar |

### Balkanlar

| Değerlendirme | Detaylar | Etki |
|---------------|----------|------|
| **Dini Çeşitlilik** | Ortodoks, Katolik, Müslüman | Çoklu tatil dönemleri |
| **AB Uyumu** | AB takvimini takip | Standart perakende takvimi |
| **Okula Dönüş** | Eylül başı | Önemli ticari an |
| **Yerel Tatiller** | Ülkeye göre değişir | Bölgesel adaptasyon |

**Balkanlara Özgü Takvim Eklemeleri:**

| Etkinlik | Zamanlama | Pazarlama Odağı |
|----------|-----------|-----------------|
| Ortodoks Noel | 7 Ocak | Sırbistan, K. Makedonya |
| Ortodoks Paskalya | Değişken | Bahar kutlaması |
| Katolik Tatiller | Standart tarihler | Seçili pazarlar |
| Yerel Ulusal Günler | Değişken | Ülkeye özgü |
...
### Çapraz Kanal Kampanya Entegrasyonu

```
┌─────────────────────────────────────────────────────────────────┐
│                 ENTEGRE KAMPANYA UYGULAMASI                      │
├─────────────────────────────────────────────────────────────────┤
│                                                                  │
│  Hafta -2: ÖNCEDEN HABER VER                                     │
│  ├── Sosyal medya ipuçları                                       │
│  ├── VIP'lere e-posta ön izleme                                  │
│  └── Vitrin ipucu                                                │
│                                                                  │
│  Hafta -1: İNŞA ET                                               │
│  ├── Tam sosyal kampanya lansmanı                                │
│  ├── Tüm veritabanına e-posta                                    │
│  ├── Mağaza içi personel hazırlığı                               │
│  └── POSM kurulumu                                               │
│                                                                  │
│  Hafta 0: LANSMAN                                                │
│  ├── Tam vitrin displayı                                         │
│  ├── Tüm kanallar aktif                                          │
│  ├── Lansman etkinliği (varsa)                                   │
│  └── PR/Influencer aktivasyonu                                   │
│                                                                  │
│  Hafta 1+: SÜRDÜR                                                │
│  ├── Hatırlatma iletişimleri                                     │
...
### Kampanya Aşamasına Göre Kanal Zamanlaması

| Aşama | Sosyal Medya | E-posta | Mağaza İçi | Ücretli Medya |
|-------|--------------|---------|------------|---------------|
| **Önceden Haber** | İpuçları, geri sayım | VIP ön izleme | İnce güncellemeler | Düşük harcama |
| **İnşa** | Tam içerik | Veritabanı gönderimi | Personel brifingi | Orta harcama |
| **Lansman** | Zirve paylaşım | Lansman hatırlatması | Tam display | Zirve harcama |
| **Sürdürme** | Etkileşim | Hatırlatmalar | Korunuyor | Optimize edilmiş |
| **Kapanış** | Son hamle | Son şans | Azaltma | Son hamle |
...
### Takvim Uyumluluk Kuralları

1. **Zorunlu Kampanyalar:** Tüm Seviye 1 kampanyalar uygulanmalıdır
2. **Zamanlama:** Kampanya başlangıç/bitiş tarihleri küresel olarak sabitlenmiştir
3. **Mesajlaşma:** Yalnızca onaylı kampanya mesajlaşması kullanın
4. **Fiyatlandırma:** Merkez onaylı fiyatlandırma ve indirimleri takip edin
5. **Raporlama:** Kampanya bitiminden 48 saat içinde performans raporları gönderin

### Karartma Dönemi Kuralları

| Karartma Türü | Açıklama | Süre |
|---------------|----------|------|
| **Yeni Sezon Lansmanı** | Yeni gelenlerde indirim yok | İlk 4 hafta |
| **Büyük İndirim Öncesi** | Resmi indirim öncesi promosyon yok | 2 hafta |
| **Marka Etkinlikleri** | Belirli marka faaliyetleri için ayrılmış | İletildiği gibi |

### Promosyonel Takvim Kuralları

| Kural | Gereksinim |
|-------|------------|
| İndirim Limitleri | Dönem başına maksimum indirim seviyeleri Merkez tarafından belirlenir |
| Birleştirme | Onaylanmadıkça birden fazla teklif birleştirme yasak |
| İletişim | Tüm promosyonel mesajlar önceden onaylanmalı |
| Süre | Promosyon dönemleri onaysız uzatılamaz |
| Kapsam | Promosyonlar yalnızca belirtilen ürün kategorilerine uygulanır |
...
### Sorun 1: Geç Kampanya Materyalleri

**Belirti:** POSM ve varlıklar kampanya başlangıç tarihinden sonra ulaşıyor.
...
**Çözüm:**
1. Materyalleri 4+ hafta önceden sipariş edin
2. Fiziksel gecikmesi durumunda ilk gün için dijital alternatifleri kullanın
3. Planlamada tampon süre uygulayın
4. Acil yerel baskı kontaklarına sahip olun
...
### Sorun 3: Envanter Uyumsuzluğu

**Belirti:** Tanıtılan ürünler kampanya sırasında mevcut değil.

**Nedenler:**
- Tahmin hataları
- Tedarik zinciri gecikmeleri
- Ticaret ekibiyle zayıf iletişim

**Çözüm:**
1. Takvimi aylık olarak ticaret ekibiyle paylaşın
2. Kampanyadan 2 hafta önce stok seviyelerini onaylayın
3. Promosyon için yedek ürünleri belirleyin
4. Stok sorunlarını hemen pazarlamaya bildirin
...
### Sezon Lansmanı Hazırlık Kontrol Listesi

- [ ] Kampanya brifingi incelendi (8 hafta önce)
- [ ] Varlıklar alındı ve onaylandı (4 hafta önce)
- [ ] POSM sipariş edildi (4 hafta önce)
- [ ] Personel eğitimi planlandı (2 hafta önce)
- [ ] Envanter doğrulandı (2 hafta önce)
- [ ] Mağaza kurulumu planlandı (1 hafta önce)
- [ ] POSM alındı (1 hafta önce)
- [ ] Dijital varlıklar planlandı (1 hafta önce)
- [ ] Personel eğitildi (3 gün önce)
- [ ] Mağaza kurulumu tamamlandı (bir gün önce)
- [ ] Lansman günü kontrol listesi hazır

### Aylık Takvim İnceleme Kontrol Listesi

- [ ] Önceki ay performansı analiz edildi
- [ ] Sonraki ay kampanyaları onaylandı
- [ ] Malzeme durumu kontrol edildi
- [ ] Bölgesel adaptasyonlar onaylandı
- [ ] Bütçe kullanımı incelendi
- [ ] Personel programları hizalandı
- [ ] Envanter uyumu doğrulandı
- [ ] Performans hedefleri belirlendi
