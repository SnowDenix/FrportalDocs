...
```
/docs
  /glossary                    # Sözlükler / Glossaries (6 files)
  /guidelines                  # Rehberler / Guidelines (6 files)
  /crm                         # CRM Dokümantasyonu / CRM Documentation (20 files)
  /marketing                   # Pazarlama / Marketing (18 files)
  /vm                          # Görsel Mağazacılık / Visual Merchandising (12 files)
  /store-operations            # Mağaza Operasyonları / Store Operations (16 files)
  /supply-chain                # Tedarik Zinciri / Supply Chain (12 files)
  /training                    # Eğitim / Training (24 files)
```
...
## 🟦 Visual Merchandising Module (12 Files)
...
## 🟩 Store Operations Module (16 Files)
...
## 🟧 Supply Chain & Logistics Module (12 Files)
...
### Retail Terms & Concepts
- Stock Cover, Stock Turnover, SKU, Sell-Through Rate
- Shelf Life, Capacity, Size Break (Kırıklık)
- Classification, Auto-Replenishment
- Transfer, Returns, Lost Sales Analysis

### Finance KPIs & Formulas
- EBIT, EBITDA, Gross Margin, Net Profit Margin
- GMROI, Stock Turnover, Sell-Through %
- UPT, ATV, Conversion Rate, ASP
- Markup, Markdown, ROS

### Supply Chain & Logistics
- Incoterms 2020 (EXW, FOB, CIF, CPT, DDP)
- SAP Transaction Codes (PO, SO, GR, GI)
- Lead Time, Cross-Docking, Consolidation
- HS Codes, Customs Documentation

### Visual Merchandising
- Golden Triangle, Eye Level Rules
- A-B-C Zone System
- Fixture Types and Capacity Standards
- Brand-Specific Guidelines (U.S. Polo, Pierre Cardin, Cacharel)

### Store Operations
- Opening/Closing Procedures
- Return & Exchange Policies
- Damage & Rejection Handling
...
- Reporting Standards (Daily, Weekly, Monthly)
...
```markdown
# Title
> Last Updated | Version | Prepared By
...
- Formulas in code blocks for easy reference
- Practical scenarios and use cases
- Checklists and forms where applicable
- Revision history for version tracking

---

## 📊 Document Summary

| Module | Documents | Languages | Total Files |
|--------|-----------|-----------|-------------|
| Glossary | 3 document pairs | TR/EN | 6 |
| Guidelines | 3 document pairs | TR/EN | 6 |
| CRM | 10 document pairs | TR/EN | 20 |
| Marketing | 9 document pairs | TR/EN | 18 |
| Visual Merchandising | 6 document pairs | TR/EN | 12 |
| Store Operations | 8 document pairs | TR/EN | 16 |
| Supply Chain | 6 document pairs | TR/EN | 12 |
| Training | 12 document pairs | TR/EN | 24 |
| **Total** | **57 document pairs** | **TR/EN** | **114** |
...
| 2.0 | December 2025 | Added Marketing, VM, Store Operations, Supply Chain, CRM, and Training modules (114 total files) |
