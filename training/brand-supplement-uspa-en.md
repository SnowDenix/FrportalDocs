...
This document provides store staff with detailed information about U.S. Polo Assn. brand identity, product features, target customer profile, and sales approaches. It contains all necessary information to deliver a customer experience that meets brand standards.
...
1. ✅ Communicate the U.S. Polo Assn. brand story
2. ✅ Explain brand values and positioning
3. ✅ Recognize product categories and features
4. ✅ Define target customer profile
5. ✅ Apply brand-specific sales techniques
6. ✅ Identify differentiation points from competitors

## Key Concepts

| Concept | Description |
|---------|-------------|
| **Heritage** | Deep-rooted legacy based on American polo sport |
| **Authentic American Style** | Authentic American lifestyle |
| **Accessible Luxury** | Accessible luxury segment |
| **Casual Premium** | Premium quality everyday wear |
| **Polo Lifestyle** | Lifestyle associated with polo sport |
...
**Positioning:** Premium quality, accessible price (Accessible Luxury)

#### 2.2 Competitor Analysis

| Competitor | Difference |
|------------|------------|
| Tommy Hilfiger | USPA more affordable, similar American style |
| Lacoste | USPA stronger polo heritage, Lacoste tennis-focused |
| Polo Ralph Lauren | USPA officially licensed, RL is designer brand |
| Gant | USPA more youthful and dynamic |

#### 2.3 USP (Unique Selling Proposition)

1. **Only Official Polo Brand:** Official licensed brand of US Polo Association
2. **Authentic Heritage:** 130+ years of real polo tradition
3. **Value Proposition:** Premium quality, smart pricing
4. **Global Reach:** Trusted brand in 180+ countries
...
**Demographic:**
- Age: 18-35
- Gender: Male dominant (60%), Female (40%)
- Income: Upper-middle segment
- Education: University student or graduate
- Location: Urban
...
**Persona 1: University Student Mert (22)**
- Social, spends time with friends
- Loves casual wear
- Price sensitive but doesn't want to compromise quality
- Favorites: Polo t-shirt, jogger, sneaker

**Persona 2: Young Professional Ayse (28)**
- Works in corporate job
- Weekend casual, weekday smart casual
- Looking for both stylish and comfortable
- Favorites: Oxford shirt, chino, polo dress

**Persona 3: Active Dad Kerem (35)**
- Spends time with his child
- Looking for practical and durable clothing
- Does family shopping
- Favorites: Polo, t-shirt, kids sets

#### 4.3 Shopping Motivations

| Motivation | Sales Approach |
|------------|----------------|
| Everyday use | Emphasize comfortable cut and durability |
| Gift | Recommend polo t-shirt, offer gift wrapping |
| Season change | Show new season collection |
| Discount | Highlight promotional items |
| Brand preference | Introduce loyalty program |
...
**Visual Identity:**
- Navy blue, white, red color palette
- Polo visual elements
- Photos inspiring American lifestyle
...
```
Staff: "Welcome to U.S. Polo Assn.! [Smile + Eye contact]
How can I help you today?"
```

#### 6.3 Fitting Room Service

- Blue/white fabric fitting room cover
- Logo-embroidered hanger
- Lighting control
- Cleanliness standard

#### 6.4 Packaging

- Brand logo kraft bag
- Tissue paper wrapping
- Brand tag/card addition
...
- Vibrant accent colors (orange, green)

**Theme:** Summer Polo / Coastal Vibes
...
| Role | Responsibility |
|------|----------------|
| **Store Staff** | Learns brand knowledge, conveys to customers, memorizes product features |
| **Store Manager** | Supervises brand standards, coaches staff, maintains visual identity |
| **Regional Trainer** | Organizes brand trainings, conveys new collection information |
| **Training HQ** | Updates brand content, prepares seasonal training materials |
...
|-----|--------|-------------|
| Brand Knowledge Score | 85%+ | Quiz evaluation |
| Product Knowledge Score | 90%+ | Product test |
| Cross-sell Rate | 30%+ | POS data |
