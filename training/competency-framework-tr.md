...
> **Kapsam:** 5 seviyeli yetkinlik sistemi, beceri matrisi, ilerleme kriterleri
...
Bu doküman, Aydınlı Grup franchise mağazalarında çalışan personelin yetkinlik gelişimini takip etmek, kariyer yolunu planlamak ve standart bir ilerleme sistemi oluşturmak amacıyla hazırlanmıştır.

**Temel Hedefler:**
- Net yetkinlik seviyeleri tanımlamak
- Personel gelişimini ölçülebilir hale getirmek
- Kariyer ilerlemesi için yol haritası sunmak
- Eğitim ihtiyaçlarını sistematik tespit etmek
...
Bu yetkinlik çerçevesini anlayan personel:

### Bilgi Düzeyinde
- [ ] 5 yetkinlik seviyesini ve özelliklerini bilir
- [ ] Her seviyenin gereksinimlerini açıklayabilir
- [ ] İlerleme kriterlerini tanımlar
- [ ] Değerlendirme sürecini kavrar

### Beceri Düzeyinde
- [ ] Kendi seviyesini doğru değerlendirebilir
- [ ] Gelişim alanlarını tespit edebilir
- [ ] İlerleme planı oluşturabilir

### Davranış Düzeyinde
- [ ] Sürekli gelişim motivasyonu taşır
- [ ] Bir sonraki seviye için çalışır
- [ ] Diğerlerinin gelişimine katkı sağlar
...
## Seviye İlerleme Kriterleri

### Seviye 1 → Seviye 2 Geçiş

```
┌─────────────────────────────────────────────────────────────────┐
│              SEVİYE 1 → SEVİYE 2 GEÇİŞ                         │
├─────────────────────────────────────────────────────────────────┤
│                                                                 │
│  ZORUNLU KRİTERLER                                             │
│  ✓ 30 gün oryantasyon tamamlama                                │
│  ✓ Sertifikasyon sınavı %70+                                   │
│  ✓ Tüm eğitim modülleri tamamlama                              │
│  ✓ Mağaza Müdürü onayı                                         │
│                                                                 │
│  PERFORMANS KRİTERLERİ                                         │
│  ✓ Pratik değerlendirme "Yeterli" veya üzeri                   │
│  ✓ Devam/devamsızlık: <%5                                      │
│  ✓ Buddy değerlendirmesi pozitif                               │
│                                                                 │
│  DAVRANIŞ KRİTERLERİ                                           │
│  ✓ Öğrenme isteği gösterme                                     │
│  ✓ Kurallara uyum                                              │
│  ✓ Ekip uyumu                                                  │
│                                                                 │
└─────────────────────────────────────────────────────────────────┘
...
### Seviye 2 → Seviye 3 Geçiş

```
┌─────────────────────────────────────────────────────────────────┐
│              SEVİYE 2 → SEVİYE 3 GEÇİŞ                         │
├─────────────────────────────────────────────────────────────────┤
│                                                                 │
│  ZORUNLU KRİTERLER                                             │
│  ✓ Minimum 3 ay Seviye 2 deneyimi                              │
│  ✓ İleri eğitim modülleri tamamlama                            │
│  ✓ Satış teknikleri sertifikası                                │
│                                                                 │
│  PERFORMANS KRİTERLERİ                                         │
│  ✓ Son 3 ay aylık hedef: %80+ tutturma                         │
│  ✓ UPT hedefi: 1.8+                                            │
│  ✓ Ek satış oranı: %30+                                        │
│  ✓ Müşteri memnuniyet skoru: 4.0/5+                            │
│                                                                 │
│  BECERİ KRİTERLERİ                                             │
│  ✓ Bağımsız satış yapabiliyor                                  │
│  ✓ İtiraz karşılama yapabiliyor                                │
│  ✓ CRM kaydı yapabiliyor                                       │
│  ✓ Tüm POS işlemlerini yapabiliyor                             │
│                                                                 │
│  DEĞERLENDİRME                                                 │
│  ✓ Mağaza Müdürü değerlendirmesi: "İyi" veya üzeri             │
│  ✓ Pratik gözlem: Tüm kriterler "Yeterli" veya üzeri           │
│                                                                 │
└─────────────────────────────────────────────────────────────────┘
```

### Seviye 3 → Seviye 4 Geçiş

```
┌─────────────────────────────────────────────────────────────────┐
│              SEVİYE 3 → SEVİYE 4 GEÇİŞ                         │
├─────────────────────────────────────────────────────────────────┤
│                                                                 │
│  ZORUNLU KRİTERLER                                             │
│  ✓ Minimum 6 ay Seviye 3 deneyimi                              │
│  ✓ Liderlik eğitim modülleri tamamlama                         │
│  ✓ Mentorluk sertifikası                                       │
│                                                                 │
│  PERFORMANS KRİTERLERİ                                         │
│  ✓ Son 6 ay aylık hedef: %100+ tutturma                        │
│  ✓ UPT hedefi: 2.0+                                            │
│  ✓ ATV hedefi: +10% mağaza ortalaması                          │
│  ✓ Müşteri memnuniyet skoru: 4.5/5+                            │
│                                                                 │
│  LİDERLİK KRİTERLERİ                                           │
│  ✓ En az 1 yeni personele mentorluk yapmış                     │
│  ✓ Vardiya sorumluluğu almış                                   │
│  ✓ Zor müşteri/senaryo yönetimi deneyimi                       │
│                                                                 │
│  DEĞERLENDİRME                                                 │
│  ✓ 360° değerlendirme: "İyi" veya üzeri                        │
│  ✓ Bölge Müdürü onayı                                          │
...
### Seviye 4 → Seviye 5 Geçiş

```
┌─────────────────────────────────────────────────────────────────┐
│              SEVİYE 4 → SEVİYE 5 GEÇİŞ                         │
├─────────────────────────────────────────────────────────────────┤
│                                                                 │
│  ZORUNLU KRİTERLER                                             │
│  ✓ Minimum 12 ay toplam deneyim                                │
│  ✓ Minimum 6 ay Seviye 4 deneyimi                              │
│  ✓ Eğitmenlik sertifikası                                      │
│  ✓ Liderlik programı tamamlama                                 │
│                                                                 │
│  PERFORMANS KRİTERLERİ                                         │
│  ✓ Son 12 ay hedef tutturma: %110+                             │
│  ✓ Mağaza en iyi performans gösterenleri arasında              │
│  ✓ Sıfır disiplin/uyarı kaydı                                  │
│                                                                 │
│  LİDERLİK KRİTERLERİ                                           │
│  ✓ En az 2 personele başarılı mentorluk                        │
│  ✓ Mağaza içi eğitim vermiş                                    │
│  ✓ Best practice geliştirmiş                                   │
│  ✓ Bölge düzeyinde katkı sağlamış                              │
│                                                                 │
│  DEĞERLENDİRME                                                 │
│  ✓ Mağaza Müdürü önerisi                                       │
│  ✓ Bölge Müdürü onayı                                          │
│  ✓ HQ değerlendirme paneli onayı                               │
│                                                                 │
└─────────────────────────────────────────────────────────────────┘
```
...
### Satış Danışmanı Kariyer Haritası

```
┌─────────────────────────────────────────────────────────────────┐
│              KARİYER YOLU HARİTASI                              │
├─────────────────────────────────────────────────────────────────┤
│                                                                 │
│                        ┌──────────────┐                        │
│                        │ BÖLGE MÜDÜRÜ │                        │
...
│     ┌──────────────┐  ┌──────────────┐  ┌──────────────┐       │
│     │ MAĞAZA       │  │   BÖLGE      │  │    ALAN      │       │
│     │ MÜDÜRÜ       │  │   EĞİTMENİ   │  │  SORUMLUSU   │       │
│     └──────┬───────┘  └──────────────┘  └──────────────┘       │
│            │                                                    │
│            ▼                                                    │
│     ┌──────────────┐                                           │
│     │ MÜD. YARD.   │  ◄── SEVİYE 5 GEREKLİ                    │
│     └──────┬───────┘                                           │
│            │                                                    │
│            ▼                                                    │
│     ┌──────────────┐                                           │
│     │  SEVİYE 5    │  (12+ ay, Uzman)                          │
│     │    UZMAN     │                                           │
│     └──────┬───────┘                                           │
│            │                                                    │
│            ▼                                                    │
│     ┌──────────────┐                                           │
│     │  SEVİYE 4    │  (6-12 ay, Kıdemli)                       │
│     │   KIDEMLİ    │                                           │
│     └──────┬───────┘                                           │
│            │                                                    │
│            ▼                                                    │
│     ┌──────────────┐                                           │
│     │  SEVİYE 3    │  (3-6 ay, Yetkin)                         │
│     │   YETKİN     │                                           │
│     └──────┬───────┘                                           │
│            │                                                    │
│            ▼                                                    │
│     ┌──────────────┐                                           │
│     │  SEVİYE 2    │  (1-3 ay, Junior)                         │
│     │   JUNİOR     │                                           │
│     └──────┬───────┘                                           │
│            │                                                    │
│            ▼                                                    │
│     ┌──────────────┐                                           │
│     │  SEVİYE 1    │  (0-30 gün, Stajyer)                      │
│     │   STAJYER    │                                           │
│     └──────────────┘                                           │
│                                                                 │
└─────────────────────────────────────────────────────────────────┘
...
### Seviye Bazlı KPI Hedefleri

| KPI | Seviye 2 | Seviye 3 | Seviye 4 | Seviye 5 |
|-----|----------|----------|----------|----------|
| **Hedef Tutturma** | %80 | %100 | %110 | %115+ |
| **UPT** | 1.6 | 1.8 | 2.0 | 2.2+ |
| **ATV** | Ortalama | +5% | +10% | +15% |
| **Ek Satış** | %20 | %35 | %45 | %55+ |
| **NPS Katkısı** | - | 50+ | 60+ | 70+ |
