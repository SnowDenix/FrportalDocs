...
Bu belge, U.S. Polo Assn. marka kimliği, ürün özellikleri, hedef müşteri profili ve satış yaklaşımları hakkında mağaza personeline detaylı bilgi sağlar. Marka standartlarına uygun müşteri deneyimi sunmak için gerekli tüm bilgileri içerir.
...
1. ✅ U.S. Polo Assn. marka hikayesini aktarabilir
2. ✅ Marka değerlerini ve konumlandırmasını açıklayabilir
3. ✅ Ürün kategorilerini ve özelliklerini tanıyabilir
4. ✅ Hedef müşteri profilini tanımlayabilir
5. ✅ Markaya özgü satış teknikleri uygulayabilir
6. ✅ Rakip markalardan farklılaşma noktalarını belirleyebilir

## Key Concepts

| Kavram | Açıklama |
|--------|----------|
| **Heritage** | Amerikan polo sporuna dayanan köklü miras |
| **Authentic American Style** | Otantik Amerikan yaşam tarzı |
| **Accessible Luxury** | Erişilebilir lüks segment |
| **Casual Premium** | Premium kalitede günlük giyim |
| **Polo Lifestyle** | Polo sporu ile özdeşleşen yaşam tarzı |
...
```
         Premium
            ↑
            |
    [Accessible Luxury] ← U.S. Polo Assn.
            |
            ↓
         Mass Market
```

**Konumlandırma:** Premium kalite, erişilebilir fiyat (Accessible Luxury)

#### 2.2 Rakip Analizi

| Rakip | Fark |
|-------|------|
| Tommy Hilfiger | USPA daha uygun fiyatlı, benzer Amerikan tarzı |
| Lacoste | USPA polo mirası daha güçlü, Lacoste tenis odaklı |
| Polo Ralph Lauren | USPA resmi lisanslı, RL tasarımcı markası |
| Gant | USPA daha genç ve dinamik |

#### 2.3 USP (Benzersiz Satış Noktası)

1. **Tek Resmi Polo Markası:** ABD Polo Birliği'nin resmi lisanslı markası
2. **Otantik Miras:** 130+ yıllık gerçek polo geleneği
3. **Değer Önerisi:** Premium kalite, akıllı fiyatlandırma
4. **Global Erişim:** 180+ ülkede güvenilir marka
...
**Demografik:**
- Yaş: 18-35
- Cinsiyet: Erkek ağırlıklı (%60), Kadın (%40)
...
- Amerikan kültürüne ilgili
- Sportif yaşam tarzı

#### 4.2 Müşteri Personaları

**Persona 1: Üniversite Öğrencisi Mert (22)**
- Sosyal, arkadaş grubuyla vakit geçirir
- Casual giyimi sever
- Fiyat hassasiyeti var ama kaliteden ödün vermek istemez
- Favori: Polo t-shirt, jogger, sneaker

**Persona 2: Genç Profesyonel Ayşe (28)**
- Kurumsal işte çalışıyor
- Hafta sonu casual, hafta içi smart casual
- Hem şık hem rahat arıyor
- Favori: Oxford gömlek, chino, polo dress

**Persona 3: Aktif Baba Kerem (35)**
- Çocuğuyla vakit geçiriyor
- Pratik ve dayanıklı giyim arıyor
- Aile alışverişi yapıyor
- Favori: Polo, t-shirt, çocuk setleri

#### 4.3 Alışveriş Motivasyonları

| Motivasyon | Satış Yaklaşımı |
|------------|-----------------|
| Günlük kullanım | Rahat kesim ve dayanıklılık vurgula |
| Hediye | Polo t-shirt öneri, hediye paketi sun |
| Sezon değişimi | Yeni sezon koleksiyonu göster |
| İndirim | Fırsat ürünlerini öne çıkar |
| Marka tercihi | Sadakat programı tanıt |
...
**Görsel Kimlik:**
- Lacivert, beyaz, kırmızı renk paleti
- Polo görsel öğeleri
- Amerikan yaşam tarzı ilham veren fotoğraflar
- Clean, organized düzen

**Müzik:**
- Upbeat, pozitif enerji
- Pop, soft rock karışımı
- Orta ses seviyesi

#### 6.2 Karşılama Standardı

```
Personel: "Hoş geldiniz U.S. Polo Assn.'a! [Gülümseme + Göz teması]
Bugün size nasıl yardımcı olabilirim?"
```

#### 6.3 Kabin Hizmeti

- Mavi/beyaz bez kabin örtüsü
- Logo işlemeli askı
- Aydınlatma kontrolü
- Temizlik standardı
...
- Marka logolu kraft çanta
- Doku kağıdı ile sarma
- Marka etiketi/kartı ekleme
...
**Anahtar Ürünler:**
- Polo t-shirt (tüm renkler)
- Chino şort
- Keten karışımlı gömlekler
- Hafif ceketler
...
- Pastel tonlar
- Beyaz, bej, açık mavi
- Canlı aksan renkleri (turuncu, yeşil)

**Tema:** Summer Polo / Coastal Vibes

#### 8.2 Sonbahar/Kış (AW)

**Anahtar Ürünler:**
- Sweatshirt ve hoodie
- Triko kazaklar
- Denim ceketler
- Mont ve parkalar
- Atkı ve bere setleri
...
| Rol | Sorumluluk |
|-----|------------|
| **Store Staff** | Marka bilgisini öğrenir, müşteriye aktarır, ürün özelliklerini ezberler |
| **Store Manager** | Marka standartlarını denetler, personeli koçlar, görsel kimliği korur |
| **Regional Trainer** | Marka eğitimlerini düzenler, yeni koleksiyon bilgisi aktarır |
| **Training HQ** | Marka içeriği günceller, sezonluk eğitim materyalleri hazırlar |
...
| KPI | Hedef | Ölçüm |
|-----|-------|-------|
| Marka Bilgisi Skoru | %85+ | Quiz değerlendirmesi |
| Ürün Bilgisi Skoru | %90+ | Ürün testi |
| Cross-sell Oranı | %30+ | POS verileri |
| Müşteri Memnuniyeti | 4.5/5 | Anket |
