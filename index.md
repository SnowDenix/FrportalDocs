...
title: Ana Sayfa
nav_order: 1
description: "Aydınlı Grup Franchise Perakende Dokümantasyonu - U.S. Polo Assn., Pierre Cardin, Cacharel"
permalink: /
---

# FR Portal Dokümantasyon Merkezi
{: .fs-9 }

Aydınlı Grup franchise operasyonları için kapsamlı perakende dokümantasyonu.
{: .fs-6 .fw-300 }

[Hızlı Başlangıç](#modüller){: .btn .btn-primary .fs-5 .mb-4 .mb-md-0 .mr-2 }
[GitHub'da Görüntüle](https://github.com/SnowDenix/FrportalDocs){: .btn .fs-5 .mb-4 .mb-md-0 }

---

## Hoş Geldiniz

Bu portal, **U.S. Polo Assn.**, **Pierre Cardin** ve **Cacharel** markalarını işleten Aydınlı Grup franchise ortakları için hazırlanmış kapsamlı dokümantasyon merkezidir.

Tüm dokümanlar **Türkçe** ve **İngilizce** olarak iki dilde sunulmaktadır.

{: .note }
> Güncel dokümanlar için düzenli olarak bu portali kontrol ediniz. Son güncelleme: **Aralık 2025**
...
<div class="brand-grid" markdown="1">

### U.S. Polo Assn.
{: .text-purple-300 }
Sportswear / Casual segmentinde tam CRM entegrasyonu ile faaliyet gösteren global marka.

### Pierre Cardin
{: .text-blue-300 }
Premium / Business segmentinde lüks perakende deneyimi sunan prestijli marka.

### Cacharel
{: .text-green-300 }
Erkek modası segmentinde şık ve modern koleksiyonlar sunan Fransız markası.
...
*Bu dokümantasyon Aydınlı Grup Franchise Operations Team tarafından hazırlanmıştır.*

**© 2025 Aydınlı Grup - Tüm hakları saklıdır.**

Bu dokümantasyon gizli ve özeldir. Dağıtımı sadece yetkili Aydınlı Grup franchise ortakları ile sınırlıdır.
